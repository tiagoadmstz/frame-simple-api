 ...
 */
public final class SeletorListaVarios extends ManipulaFrames {
    ...
    public SeletorListaVarios(TableModelDefaultAdapter modelTbDestino_1, List<?> resultado) {
        setImageIcon();
        initComponents();
        listener = new Listener_SeletorListaVarios(this);
    ...
    private void initComponents() {
        ...
        btAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sres/img/setaDireita.gif"))); // NOI18N
        btAdicionar.setActionCommand("adicionar");

        btRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sres/img/setaEsquerda.gif"))); // NOI18N
        btRemover.setActionCommand("remover");

        btAddTodas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sres/img/setaDireitaFinal.gif"))); // NOI18N
        btAddTodas.setActionCommand("adicionarTodas");

        btRemoverTodas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/sres/img/setaEsquerdaInicio.gif"))); // NOI18N
        ...
        painelMainLayout.setHorizontalGroup(
            ...
            .addGroup(painelMainLayout.createSequentialGroup()
                ...
                .addGroup(painelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(scTabelaDestOpcao, javax.swing.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE))
                .addGroup(painelMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(painelMainLayout.createSequentialGroup()
                        ...
                        .addGap(6, 6, 6)
                        .addComponent(scTabelaDestSelecionada, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeletorListaVarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeletorListaVarios().setVisible(true);
            }
        });
    }
    ...
    private final class Listener_SeletorListaVarios extends ListenerPatternAdapter<SeletorListaVarios> {
        ...
        public Listener_SeletorListaVarios(SeletorListaVarios form) {
            super(form);
            initComponents();
        }
